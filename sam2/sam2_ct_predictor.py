...
sys.path.insert(0, '/app/segment-anything-2/')
from sam2.modeling.sam2_base import NO_OBJ_SCORE, SAM2Base
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_ct_slices

class SAM2CTPredictor(SAM2Base):
